...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $categories = [
            ...
            ['name' => 'Drugs', 'parent_category_id' => 5, 'category' => 'Substances'],
            ['name' => 'Chemicals', 'parent_category_id' => 5, 'category' => 'Substances'],
            ['name' => 'Others', 'parent_category_id' => 5, 'category' => 'Substances'],

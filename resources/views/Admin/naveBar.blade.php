<div class="nav-bar">
    <div class="start-menus">
        <div class="logo">
            <a href="/whales/admin/{{ $user->public_name }}/show">
                <img src="data:image/png;base64,{{ $icon['whale'] }}" alt="">
            </a>
        </div>
        <div class="name">
            <a href="/whales/admin/{{ $user->public_name }}/show"><span class="w">WHALES</span> <span
                    class="m">/Admin</span></a>
        </div>
    </div>
    <div class="end-menus">
        <div class="notification">
            <a href="/whales/admin/{{ $user->public_name }}/show/messages" target="" rel="noopener noreferrer"> <img
        ...
        <div class="notification">
            <a href="/whales/admin/{{ $user->public_name }}/show/notifications" target="" rel="noopener noreferrer"> <img
        ...
        <div class="notification">
            <a href="/whales/admin/{{ $user->public_name }}/show/settings" target="" rel="noopener noreferrer"> <img

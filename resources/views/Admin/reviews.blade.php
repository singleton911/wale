<h3 style="text-transform: capitalize; text-align: center;">
  <span style="color:#28a745">
      Listing's Reviews ({{ $reviews->count() }})
  </span>
  <hr>
</h3>
<div class="products-overview">
      ...
      <div class="displayed-reviews" style="padding: 0px;">
          ...
          <div class="reviewer-reviews">
              ...
              <div class="rating-texts">
                  <a
                      href="/store/{{ $review->store->store_name }}/show/view/{{ $review->product->created_at->timestamp }}/{{ $review->product->id }}">{{ $review->product->product_name }}</a>
                  <p style="margin-top: 5px;"> {{ $review->comment }} <br>
                      
                  <form
                      action="/store/{{ $review->store->store_name }}/show/reply/review/{{ $review->created_at->timestamp }}/{{ $review->id }}"
  ...
  {{-- {{ $reviews->paginate(50)->render('vendor.pagination.custom_pagination') }} --}}

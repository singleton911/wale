...
<div class="latest-orders">
    <div class="title-latest">
        ...
        <div class="view-latest">
            <a href="/store/{{ $store->store_name }}/orders">VIEW ALL</a>
        </div>
    </div>
    <div>
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="submit" style="background-color: darkgreen; color: #f1f1f1; cursor:pointer; padding: 5px; border: none; border-radius: .5rem;" name="accept">Accept</button>
                        <button type="submit" style="background-color: rgb(0, 75, 128); color: #f1f1f1; cursor:pointer; padding: 5px; border: none; border-radius: .5rem;" name="view">View</button>
                        <button type="submit" style="background-color: darkred; color: #f1f1f1; cursor:pointer; padding: 5px; border: none; border-radius: .5rem;" name="cancel">Cancel</button>
                        </form> --}}
                    </td>

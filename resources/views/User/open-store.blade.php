                    ...
                    <div>
                        ...
                        @else
                            <form action="" method="post">
                                @csrf
                                <input type="text" class="publicName" name="store_key"
                                    placeholder="Enter your store key (64-128 characters)" required><br>
                                <span class="cls-1 publicName-spn">You can find your store key, <br> In Market >
                                    Settings >
                                    Account >
                                    Store key.</span><br>

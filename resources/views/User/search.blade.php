...
<body>
    ...
    <div class="container">
        <div class="main-div">
                ...
                <div>
                    ...
                    <div class="categories search-div">
                        @if (session('advance_search'))
                            <h3>Advance Search Listings/Stores</h3>
                        @else
                            <h3>Quick Search Listings
                                <form action="" method="get" class="search-form" style="padding: .5em;">
                                    @csrf
            ...
            <div class="listing-name">
                <h3 style="color: #3498db;">
                    ...
                    @elseif($is_sub_category)
                        {{ 'Category > ' . $categoryName }}
                    @else
                        Search > Listings({{ $search_products->count() }} found)
                    @endif
                </h3>
            </div>
            ...
            {{-- {{ $search_products->links('vendor.pagination.custom_pagination') }} --}}
